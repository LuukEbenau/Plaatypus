...
export default function Page() {
  ...
  <div>
    <div className="profile-block">
      ...
      <p>
      Van het geld dat hij hiermee verdient, koopt hij platen, hij is een groot platenliefhebber. Een klein jc uitje was daarom ook naar de platenmarkt.
      Tijdens het luisteren naar deze platen nuttigt hij graag een glas whiskey. Hij heeft een hele kast vol. Deze whiskey sleept hem ook door zijn zware studie, hij studeert net als Pascal natuurkunde. Geregeld drinkt hij ook whiskey bij spelletjes-avonden met andere jc-leden, waar menig dobbelsteen versleten wordt. 
      </p>
